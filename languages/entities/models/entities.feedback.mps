...
<model ref="r:da330ac8-a5e2-49b3-93d3-a8b0902ddf46(entities.feedback)">
  ...
  <node concept="3QByoM" id="4higIaTk9Od">
    <ref role="3Z9TSV" to="5huh:5sdBcUEVDmY" resolve="Attribute" />
    <node concept="3QByp$" id="4higIaTk9Yf" role="3QBEN7">
      <node concept="16I2mz" id="4higIaTk9Yg" role="16N$OO">
        <node concept="16N$OT" id="4higIaTk9Yh" role="16I2mt">
          <property role="16N$OU" value="Only one Attribute may be primary" />
        </node>
      </node>
      <node concept="1GjwBS" id="4higIaTk9Ye" role="3JXyrO">
        <ref role="sa$J1" to="fudv:1mFJTG7e$j" resolve="FailingPropertyConstraints" />
        <ref role="1Gj$d9" to="5huh:5sdBcUEVDnq" resolve="primary" />
      </node>
    </node>
  </node>
</model>
